...
static int addNode(LinkedList* this, int nodeIndex,void* pElement)
{
    int returnAux = -1;
    int len;
    Node* pNuevoNodo=malloc(sizeof(Node));
        ...
        if(nodeIndex>=0 && nodeIndex<=len)
        {
            if(pNuevoNodo!=NULL)
            {
                ...
                else
                {
                    ...
                    pNuevoNodo->pNextNode=pNodoActual->pNextNode;
                    pNodoActual->pNextNode=pNuevoNodo;
                    this->size++;
                    returnAux=0;
                }
            }
...
int ll_push(LinkedList* this, int index, void* pElement)
{
    ...
    if(this!=NULL)
    {
        ...
        if(index>=0 && index<=len)
        {
            set=addNode(this,index,pElement);
            if(set==0)
            {
                returnAux=0;
            }
...
int ll_containsAll(LinkedList* this,LinkedList* this2)
{
    ...
    if(this!=NULL && this2!=NULL)
    {
        ...
        for(i=0; i<len2; i++)
        {
            ...
            contenido=ll_contains(this,pElemento);
            if(contenido==0)
            {
                returnAux=0;
                break;
